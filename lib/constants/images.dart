...
// ! interestedTypes Screen
  ...
  static const String graph = "$rootImages/graph.png";
  ...
  static const String indonesia = "$rootImages/Indonesia.png";
  static const String philiphines = "$rootImages/Philiphines.png";
  static const String polandia = "$rootImages/Polandia.png";
  static const String india = "$rootImages/India.png";
  static const String vietnam = "$rootImages/Vietnam.png";
  static const String china = "$rootImages/China.png";
  static const String canada = "$rootImages/Canada.png";
